...
const LIST: Palette[] = [
  ...
  {
    // Hair. Read as one soft mass, not as strands: at play distance a strand is
    // a fraction of a pixel, and trying to draw them produces static.
    key: 'hair.dark',
    family: 'flesh',
    base: 0x2b211c,
    shade: 0x120d0b,
    ...
    metalness: 0.0,
    bump: 0.4,
    relief: { kind: 'fiber', scale: 3.0, warp: 0.35, depth: 0.3, octaves: 4, stretch: 10 },
    variance: 0.14,
    ao: 0.6,
    sheen: 0.5,
    repeat: 1,
    passes: [
      p('glaze', 0.6, { mask: 'peak', rough: -0.16 }),
      p('stain', 0.25, { mask: 'low', color: 0x0e0a08, rough: 0.05 }),
    ],
  },
  {
    key: 'hair.fair',
    ...
    repeat: 1,
    passes: [
      p('glaze', 0.65, { mask: 'peak', rough: -0.18 }),
      p('stain', 0.2, { mask: 'low', color: 0x3d2d1c, rough: 0.05 }),
    ],
  },
  {
    key: 'skin.tan',
