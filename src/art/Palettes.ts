...
const LIST: Palette[] = [
  ...
  // ======================= CLOTH =========================================
  {
    ...
    metalness: 0.0,
    bump: 0.8,
    relief: { kind: 'weave', scale: 3.0, warp: 0.3, depth: 0.55, octaves: 4, cells: 30 },
    variance: 0.2,
    ao: 0.8,
    repeat: 1,
    passes: [
      p('fray', 0.6, { color: 0x8d8067, scale: 16, rough: 0.1 }),
      p('stain', 0.5, { mask: 'low', color: 0x6d604a, rough: -0.06 }),
      p('dust', 0.4, { mask: 'ledge', color: 0xbfb49a }),
      p('speckle', 0.25, { color: 0x8a7d66, scale: 18 }),
    ],
  },
  {
    key: 'cloth.silk',
    ...
    passes: [
      ...
      p('fray', 0.25, { color: 0x8d6fa0, scale: 20, rough: 0.06 }),
  ...
  },
  {
    ...
    metalness: 0.0,
    bump: 1.0,
    relief: { kind: 'weave', scale: 3.0, warp: 0.55, depth: 0.7, octaves: 5, cells: 22 },
    variance: 0.34,
    ao: 0.95,
    repeat: 1,
    passes: [
      p('fray', 0.95, { color: 0x7c7062, scale: 12, rough: 0.14, height: -0.3 }),
  ...
  },
  {
    ...
    metalness: 0.0,
    bump: 0.75,
    relief: { kind: 'weave', scale: 3.0, warp: 0.35, depth: 0.5, octaves: 4, cells: 26 },
    variance: 0.22,
    ao: 0.8,
    repeat: 1,
    passes: [
      p('emboss', 0.6, { height: 0.2, scale: 2.2, color: 0xc9a24a }),
      p('fray', 0.55, { color: 0x8f4437, scale: 14, rough: 0.1 }),
  ...
  // ======================= LEATHER =======================================
  {
    ...
    metalness: 0.0,
    bump: 0.9,
    relief: { kind: 'hide', scale: 3.0, warp: 0.6, depth: 0.55, octaves: 5, cells: 22, jitter: 0.9 },
    variance: 0.28,
    ao: 0.8,
    repeat: 1,
    passes: [
  ...
  },
  {
    ...
    metalness: 0.0,
    bump: 1.1,
    relief: { kind: 'hide', scale: 3.0, warp: 0.6, depth: 0.55, octaves: 5, cells: 20, jitter: 0.85 },
    variance: 0.24,
    ao: 0.85,
    repeat: 1,
    passes: [
  ...
  },
  {
    ...
    metalness: 0.0,
    bump: 0.65,
    relief: { kind: 'hide', scale: 3.0, warp: 0.45, depth: 0.35, octaves: 5, cells: 34, jitter: 0.8 },
    variance: 0.16,
    ao: 0.6,
    sheen: 0.25,
    repeat: 1,
    passes: [
      p('emboss', 0.5, { height: 0.18, scale: 2.6, color: 0xa08a5c }),
